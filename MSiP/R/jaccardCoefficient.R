...
#' @return Data frame containing bait-prey pairs with the Jaccard coefficient
...
#' @description This function computes the Jaccard similarity coefficient scores for instances

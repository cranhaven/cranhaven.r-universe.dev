...
size_t* getivector( const size_t nr, const size_t c )
...
static int inverse3x3( const size_t n, double** const a )
{
  ...
  double det = a[1][1] * r[0] + a[2][1] * r[1] + a[3][1] * r[2];
  if ( iszero( det ) ) return 1;
  det = 1.0 / det;
...
static int inverse4x4( const size_t n, double** const a )
{
  ...
  double det = a[1][1] * r[0] + a[2][1] * r[1] + a[3][1] * r[2] + a[4][1] * r[3];
...
static int inverse5x5( const size_t n, double** const a )
{
  int retval = 0;

  if ( n != 5 ) return retval = 1;

  const double a11 = a[1][1];
  const double a12 = a[1][2];
  const double a13 = a[1][3];
  const double a14 = a[1][4];
  const double a15 = a[1][5];
  const double a21 = a[2][1];
  const double a22 = a[2][2];
  const double a23 = a[2][3];
  const double a24 = a[2][4];
  const double a25 = a[2][5];
  const double a31 = a[3][1];
  const double a32 = a[3][2];
  const double a33 = a[3][3];
  const double a34 = a[3][4];
  const double a35 = a[3][5];
  const double a41 = a[4][1];
  const double a42 = a[4][2];
  const double a43 = a[4][3];
  const double a44 = a[4][4];
  const double a45 = a[4][5];
  const double a51 = a[5][1];
  const double a52 = a[5][2];
  const double a53 = a[5][3];
  const double a54 = a[5][4];
  const double a55 = a[5][5];

  double det = a15 * a24 * a33 * a42 * a51 - a14 * a25 * a33 * a42 * a51 - a15 * a23 * a34 * a42 * a51 + a13 * a25 * a34 * a42 * a51 + a14 * a23 * a35 * a42 * a51 - a13 * a24 * a35 * a42 * a51 - a15 * a24 * a32 * a43 * a51 + a14 * a25 * a32 * a43 * a51 + a15 * a22 * a34 * a43 * a51 - a12 * a25 * a34 * a43 * a51 - a14 * a22 * a35 * a43 * a51 + a12 * a24 * a35 * a43 * a51 + a15 * a23 * a32 * a44 * a51 - a13 * a25 * a32 * a44 * a51 - a15 * a22 * a33 * a44 * a51 + a12 * a25 * a33 * a44 * a51 + a13 * a22 * a35 * a44 * a51 - a12 * a23 * a35 * a44 * a51 - a14 * a23 * a32 * a45 * a51 + a13 * a24 * a32 * a45 * a51 + a14 * a22 * a33 * a45 * a51 - a12 * a24 * a33 * a45 * a51 - a13 * a22 * a34 * a45 * a51 + a12 * a23 * a34 * a45 * a51 - a15 * a24 * a33 * a41 * a52 + a14 * a25 * a33 * a41 * a52 + a15 * a23 * a34 * a41 * a52 - a13 * a25 * a34 * a41 * a52 - a14 * a23 * a35 * a41 * a52 + a13 * a24 * a35 * a41 * a52 + a15 * a24 * a31 * a43 * a52 - a14 * a25 * a31 * a43 * a52 - a15 * a21 * a34 * a43 * a52 + a11 * a25 * a34 * a43 * a52 + a14 * a21 * a35 * a43 * a52 - a11 * a24 * a35 * a43 * a52 - a15 * a23 * a31 * a44 * a52 + a13 * a25 * a31 * a44 * a52 + a15 * a21 * a33 * a44 * a52 - a11 * a25 * a33 * a44 * a52 - a13 * a21 * a35 * a44 * a52 + a11 * a23 * a35 * a44 * a52 + a14 * a23 * a31 * a45 * a52 - a13 * a24 * a31 * a45 * a52 - a14 * a21 * a33 * a45 * a52 + a11 * a24 * a33 * a45 * a52 + a13 * a21 * a34 * a45 * a52 - a11 * a23 * a34 * a45 * a52 + a15 * a24 * a32 * a41 * a53 - a14 * a25 * a32 * a41 * a53 - a15 * a22 * a34 * a41 * a53 + a12 * a25 * a34 * a41 * a53 + a14 * a22 * a35 * a41 * a53 - a12 * a24 * a35 * a41 * a53 - a15 * a24 * a31 * a42 * a53 + a14 * a25 * a31 * a42 * a53 + a15 * a21 * a34 * a42 * a53 - a11 * a25 * a34 * a42 * a53 - a14 * a21 * a35 * a42 * a53 + a11 * a24 * a35 * a42 * a53 + a15 * a22 * a31 * a44 * a53 - a12 * a25 * a31 * a44 * a53 - a15 * a21 * a32 * a44 * a53 + a11 * a25 * a32 * a44 * a53 + a12 * a21 * a35 * a44 * a53 - a11 * a22 * a35 * a44 * a53 - a14 * a22 * a31 * a45 * a53 + a12 * a24 * a31 * a45 * a53 + a14 * a21 * a32 * a45 * a53 - a11 * a24 * a32 * a45 * a53 - a12 * a21 * a34 * a45 * a53 + a11 * a22 * a34 * a45 * a53 - a15 * a23 * a32 * a41 * a54 + a13 * a25 * a32 * a41 * a54 + a15 * a22 * a33 * a41 * a54 - a12 * a25 * a33 * a41 * a54 - a13 * a22 * a35 * a41 * a54 + a12 * a23 * a35 * a41 * a54 + a15 * a23 * a31 * a42 * a54 - a13 * a25 * a31 * a42 * a54 - a15 * a21 * a33 * a42 * a54 + a11 * a25 * a33 * a42 * a54 + a13 * a21 * a35 * a42 * a54 - a11 * a23 * a35 * a42 * a54 - a15 * a22 * a31 * a43 * a54 + a12 * a25 * a31 * a43 * a54 + a15 * a21 * a32 * a43 * a54 - a11 * a25 * a32 * a43 * a54 - a12 * a21 * a35 * a43 * a54 + a11 * a22 * a35 * a43 * a54 + a13 * a22 * a31 * a45 * a54 - a12 * a23 * a31 * a45 * a54 - a13 * a21 * a32 * a45 * a54 + a11 * a23 * a32 * a45 * a54 + a12 * a21 * a33 * a45 * a54 - a11 * a22 * a33 * a45 * a54 + a14 * a23 * a32 * a41 * a55 - a13 * a24 * a32 * a41 * a55 - a14 * a22 * a33 * a41 * a55 + a12 * a24 * a33 * a41 * a55 + a13 * a22 * a34 * a41 * a55 - a12 * a23 * a34 * a41 * a55 - a14 * a23 * a31 * a42 * a55 + a13 * a24 * a31 * a42 * a55 + a14 * a21 * a33 * a42 * a55 - a11 * a24 * a33 * a42 * a55 - a13 * a21 * a34 * a42 * a55 + a11 * a23 * a34 * a42 * a55 + a14 * a22 * a31 * a43 * a55 - a12 * a24 * a31 * a43 * a55 - a14 * a21 * a32 * a43 * a55 + a11 * a24 * a32 * a43 * a55 + a12 * a21 * a34 * a43 * a55 - a11 * a22 * a34 * a43 * a55 - a13 * a22 * a31 * a44 * a55 + a12 * a23 * a31 * a44 * a55 + a13 * a21 * a32 * a44 * a55 - a11 * a23 * a32 * a44 * a55 - a12 * a21 * a33 * a44 * a55 + a11 * a22 * a33 * a44 * a55;
  if ( iszero( det ) ) return retval = 2;

  a[1][1] = a25 * a34 * a43 * a52 - a24 * a35 * a43 * a52 - a25 * a33 * a44 * a52 + a23 * a35 * a44 * a52 + a24 * a33 * a45 * a52 - a23 * a34 * a45 * a52 - a25 * a34 * a42 * a53 + a24 * a35 * a42 * a53 + a25 * a32 * a44 * a53 - a22 * a35 * a44 * a53 - a24 * a32 * a45 * a53 + a22 * a34 * a45 * a53 + a25 * a33 * a42 * a54 - a23 * a35 * a42 * a54 - a25 * a32 * a43 * a54 + a22 * a35 * a43 * a54 + a23 * a32 * a45 * a54 - a22 * a33 * a45 * a54 - a24 * a33 * a42 * a55 + a23 * a34 * a42 * a55 + a24 * a32 * a43 * a55 - a22 * a34 * a43 * a55 - a23 * a32 * a44 * a55 + a22 * a33 * a44 * a55;
  a[1][2] = -a15 * a34 * a43 * a52 + a14 * a35 * a43 * a52 + a15 * a33 * a44 * a52 - a13 * a35 * a44 * a52 - a14 * a33 * a45 * a52 + a13 * a34 * a45 * a52 + a15 * a34 * a42 * a53 - a14 * a35 * a42 * a53 - a15 * a32 * a44 * a53 + a12 * a35 * a44 * a53 + a14 * a32 * a45 * a53 - a12 * a34 * a45 * a53 - a15 * a33 * a42 * a54 + a13 * a35 * a42 * a54 + a15 * a32 * a43 * a54 - a12 * a35 * a43 * a54 - a13 * a32 * a45 * a54 + a12 * a33 * a45 * a54 + a14 * a33 * a42 * a55 - a13 * a34 * a42 * a55 - a14 * a32 * a43 * a55 + a12 * a34 * a43 * a55 + a13 * a32 * a44 * a55 - a12 * a33 * a44 * a55;
  a[1][3] = a15 * a24 * a43 * a52 - a14 * a25 * a43 * a52 - a15 * a23 * a44 * a52 + a13 * a25 * a44 * a52 + a14 * a23 * a45 * a52 - a13 * a24 * a45 * a52 - a15 * a24 * a42 * a53 + a14 * a25 * a42 * a53 + a15 * a22 * a44 * a53 - a12 * a25 * a44 * a53 - a14 * a22 * a45 * a53 + a12 * a24 * a45 * a53 + a15 * a23 * a42 * a54 - a13 * a25 * a42 * a54 - a15 * a22 * a43 * a54 + a12 * a25 * a43 * a54 + a13 * a22 * a45 * a54 - a12 * a23 * a45 * a54 - a14 * a23 * a42 * a55 + a13 * a24 * a42 * a55 + a14 * a22 * a43 * a55 - a12 * a24 * a43 * a55 - a13 * a22 * a44 * a55 + a12 * a23 * a44 * a55;
  a[1][4] = -a15 * a24 * a33 * a52 + a14 * a25 * a33 * a52 + a15 * a23 * a34 * a52 - a13 * a25 * a34 * a52 - a14 * a23 * a35 * a52 + a13 * a24 * a35 * a52 + a15 * a24 * a32 * a53 - a14 * a25 * a32 * a53 - a15 * a22 * a34 * a53 + a12 * a25 * a34 * a53 + a14 * a22 * a35 * a53 - a12 * a24 * a35 * a53 - a15 * a23 * a32 * a54 + a13 * a25 * a32 * a54 + a15 * a22 * a33 * a54 - a12 * a25 * a33 * a54 - a13 * a22 * a35 * a54 + a12 * a23 * a35 * a54 + a14 * a23 * a32 * a55 - a13 * a24 * a32 * a55 - a14 * a22 * a33 * a55 + a12 * a24 * a33 * a55 + a13 * a22 * a34 * a55 - a12 * a23 * a34 * a55;
  a[1][5] = a15 * a24 * a33 * a42 - a14 * a25 * a33 * a42 - a15 * a23 * a34 * a42 + a13 * a25 * a34 * a42 + a14 * a23 * a35 * a42 - a13 * a24 * a35 * a42 - a15 * a24 * a32 * a43 + a14 * a25 * a32 * a43 + a15 * a22 * a34 * a43 - a12 * a25 * a34 * a43 - a14 * a22 * a35 * a43 + a12 * a24 * a35 * a43 + a15 * a23 * a32 * a44 - a13 * a25 * a32 * a44 - a15 * a22 * a33 * a44 + a12 * a25 * a33 * a44 + a13 * a22 * a35 * a44 - a12 * a23 * a35 * a44 - a14 * a23 * a32 * a45 + a13 * a24 * a32 * a45 + a14 * a22 * a33 * a45 - a12 * a24 * a33 * a45 - a13 * a22 * a34 * a45 + a12 * a23 * a34 * a45;
  a[2][1] = -a25 * a34 * a43 * a51 + a24 * a35 * a43 * a51 + a25 * a33 * a44 * a51 - a23 * a35 * a44 * a51 - a24 * a33 * a45 * a51 + a23 * a34 * a45 * a51 + a25 * a34 * a41 * a53 - a24 * a35 * a41 * a53 - a25 * a31 * a44 * a53 + a21 * a35 * a44 * a53 + a24 * a31 * a45 * a53 - a21 * a34 * a45 * a53 - a25 * a33 * a41 * a54 + a23 * a35 * a41 * a54 + a25 * a31 * a43 * a54 - a21 * a35 * a43 * a54 - a23 * a31 * a45 * a54 + a21 * a33 * a45 * a54 + a24 * a33 * a41 * a55 - a23 * a34 * a41 * a55 - a24 * a31 * a43 * a55 + a21 * a34 * a43 * a55 + a23 * a31 * a44 * a55 - a21 * a33 * a44 * a55;
  a[2][2] = a15 * a34 * a43 * a51 - a14 * a35 * a43 * a51 - a15 * a33 * a44 * a51 + a13 * a35 * a44 * a51 + a14 * a33 * a45 * a51 - a13 * a34 * a45 * a51 - a15 * a34 * a41 * a53 + a14 * a35 * a41 * a53 + a15 * a31 * a44 * a53 - a11 * a35 * a44 * a53 - a14 * a31 * a45 * a53 + a11 * a34 * a45 * a53 + a15 * a33 * a41 * a54 - a13 * a35 * a41 * a54 - a15 * a31 * a43 * a54 + a11 * a35 * a43 * a54 + a13 * a31 * a45 * a54 - a11 * a33 * a45 * a54 - a14 * a33 * a41 * a55 + a13 * a34 * a41 * a55 + a14 * a31 * a43 * a55 - a11 * a34 * a43 * a55 - a13 * a31 * a44 * a55 + a11 * a33 * a44 * a55;
  a[2][3] = -a15 * a24 * a43 * a51 + a14 * a25 * a43 * a51 + a15 * a23 * a44 * a51 - a13 * a25 * a44 * a51 - a14 * a23 * a45 * a51 + a13 * a24 * a45 * a51 + a15 * a24 * a41 * a53 - a14 * a25 * a41 * a53 - a15 * a21 * a44 * a53 + a11 * a25 * a44 * a53 + a14 * a21 * a45 * a53 - a11 * a24 * a45 * a53 - a15 * a23 * a41 * a54 + a13 * a25 * a41 * a54 + a15 * a21 * a43 * a54 - a11 * a25 * a43 * a54 - a13 * a21 * a45 * a54 + a11 * a23 * a45 * a54 + a14 * a23 * a41 * a55 - a13 * a24 * a41 * a55 - a14 * a21 * a43 * a55 + a11 * a24 * a43 * a55 + a13 * a21 * a44 * a55 - a11 * a23 * a44 * a55;
  a[2][4] = a15 * a24 * a33 * a51 - a14 * a25 * a33 * a51 - a15 * a23 * a34 * a51 + a13 * a25 * a34 * a51 + a14 * a23 * a35 * a51 - a13 * a24 * a35 * a51 - a15 * a24 * a31 * a53 + a14 * a25 * a31 * a53 + a15 * a21 * a34 * a53 - a11 * a25 * a34 * a53 - a14 * a21 * a35 * a53 + a11 * a24 * a35 * a53 + a15 * a23 * a31 * a54 - a13 * a25 * a31 * a54 - a15 * a21 * a33 * a54 + a11 * a25 * a33 * a54 + a13 * a21 * a35 * a54 - a11 * a23 * a35 * a54 - a14 * a23 * a31 * a55 + a13 * a24 * a31 * a55 + a14 * a21 * a33 * a55 - a11 * a24 * a33 * a55 - a13 * a21 * a34 * a55 + a11 * a23 * a34 * a55;
  a[2][5] = -a15 * a24 * a33 * a41 + a14 * a25 * a33 * a41 + a15 * a23 * a34 * a41 - a13 * a25 * a34 * a41 - a14 * a23 * a35 * a41 + a13 * a24 * a35 * a41 + a15 * a24 * a31 * a43 - a14 * a25 * a31 * a43 - a15 * a21 * a34 * a43 + a11 * a25 * a34 * a43 + a14 * a21 * a35 * a43 - a11 * a24 * a35 * a43 - a15 * a23 * a31 * a44 + a13 * a25 * a31 * a44 + a15 * a21 * a33 * a44 - a11 * a25 * a33 * a44 - a13 * a21 * a35 * a44 + a11 * a23 * a35 * a44 + a14 * a23 * a31 * a45 - a13 * a24 * a31 * a45 - a14 * a21 * a33 * a45 + a11 * a24 * a33 * a45 + a13 * a21 * a34 * a45 - a11 * a23 * a34 * a45;
  a[3][1] = a25 * a34 * a42 * a51 - a24 * a35 * a42 * a51 - a25 * a32 * a44 * a51 + a22 * a35 * a44 * a51 + a24 * a32 * a45 * a51 - a22 * a34 * a45 * a51 - a25 * a34 * a41 * a52 + a24 * a35 * a41 * a52 + a25 * a31 * a44 * a52 - a21 * a35 * a44 * a52 - a24 * a31 * a45 * a52 + a21 * a34 * a45 * a52 + a25 * a32 * a41 * a54 - a22 * a35 * a41 * a54 - a25 * a31 * a42 * a54 + a21 * a35 * a42 * a54 + a22 * a31 * a45 * a54 - a21 * a32 * a45 * a54 - a24 * a32 * a41 * a55 + a22 * a34 * a41 * a55 + a24 * a31 * a42 * a55 - a21 * a34 * a42 * a55 - a22 * a31 * a44 * a55 + a21 * a32 * a44 * a55;
  a[3][2] = -a15 * a34 * a42 * a51 + a14 * a35 * a42 * a51 + a15 * a32 * a44 * a51 - a12 * a35 * a44 * a51 - a14 * a32 * a45 * a51 + a12 * a34 * a45 * a51 + a15 * a34 * a41 * a52 - a14 * a35 * a41 * a52 - a15 * a31 * a44 * a52 + a11 * a35 * a44 * a52 + a14 * a31 * a45 * a52 - a11 * a34 * a45 * a52 - a15 * a32 * a41 * a54 + a12 * a35 * a41 * a54 + a15 * a31 * a42 * a54 - a11 * a35 * a42 * a54 - a12 * a31 * a45 * a54 + a11 * a32 * a45 * a54 + a14 * a32 * a41 * a55 - a12 * a34 * a41 * a55 - a14 * a31 * a42 * a55 + a11 * a34 * a42 * a55 + a12 * a31 * a44 * a55 - a11 * a32 * a44 * a55;
  a[3][3] = a15 * a24 * a42 * a51 - a14 * a25 * a42 * a51 - a15 * a22 * a44 * a51 + a12 * a25 * a44 * a51 + a14 * a22 * a45 * a51 - a12 * a24 * a45 * a51 - a15 * a24 * a41 * a52 + a14 * a25 * a41 * a52 + a15 * a21 * a44 * a52 - a11 * a25 * a44 * a52 - a14 * a21 * a45 * a52 + a11 * a24 * a45 * a52 + a15 * a22 * a41 * a54 - a12 * a25 * a41 * a54 - a15 * a21 * a42 * a54 + a11 * a25 * a42 * a54 + a12 * a21 * a45 * a54 - a11 * a22 * a45 * a54 - a14 * a22 * a41 * a55 + a12 * a24 * a41 * a55 + a14 * a21 * a42 * a55 - a11 * a24 * a42 * a55 - a12 * a21 * a44 * a55 + a11 * a22 * a44 * a55;
  a[3][4] = -a15 * a24 * a32 * a51 + a14 * a25 * a32 * a51 + a15 * a22 * a34 * a51 - a12 * a25 * a34 * a51 - a14 * a22 * a35 * a51 + a12 * a24 * a35 * a51 + a15 * a24 * a31 * a52 - a14 * a25 * a31 * a52 - a15 * a21 * a34 * a52 + a11 * a25 * a34 * a52 + a14 * a21 * a35 * a52 - a11 * a24 * a35 * a52 - a15 * a22 * a31 * a54 + a12 * a25 * a31 * a54 + a15 * a21 * a32 * a54 - a11 * a25 * a32 * a54 - a12 * a21 * a35 * a54 + a11 * a22 * a35 * a54 + a14 * a22 * a31 * a55 - a12 * a24 * a31 * a55 - a14 * a21 * a32 * a55 + a11 * a24 * a32 * a55 + a12 * a21 * a34 * a55 - a11 * a22 * a34 * a55;
  a[3][5] = a15 * a24 * a32 * a41 - a14 * a25 * a32 * a41 - a15 * a22 * a34 * a41 + a12 * a25 * a34 * a41 + a14 * a22 * a35 * a41 - a12 * a24 * a35 * a41 - a15 * a24 * a31 * a42 + a14 * a25 * a31 * a42 + a15 * a21 * a34 * a42 - a11 * a25 * a34 * a42 - a14 * a21 * a35 * a42 + a11 * a24 * a35 * a42 + a15 * a22 * a31 * a44 - a12 * a25 * a31 * a44 - a15 * a21 * a32 * a44 + a11 * a25 * a32 * a44 + a12 * a21 * a35 * a44 - a11 * a22 * a35 * a44 - a14 * a22 * a31 * a45 + a12 * a24 * a31 * a45 + a14 * a21 * a32 * a45 - a11 * a24 * a32 * a45 - a12 * a21 * a34 * a45 + a11 * a22 * a34 * a45;
  a[4][1] = -a25 * a33 * a42 * a51 + a23 * a35 * a42 * a51 + a25 * a32 * a43 * a51 - a22 * a35 * a43 * a51 - a23 * a32 * a45 * a51 + a22 * a33 * a45 * a51 + a25 * a33 * a41 * a52 - a23 * a35 * a41 * a52 - a25 * a31 * a43 * a52 + a21 * a35 * a43 * a52 + a23 * a31 * a45 * a52 - a21 * a33 * a45 * a52 - a25 * a32 * a41 * a53 + a22 * a35 * a41 * a53 + a25 * a31 * a42 * a53 - a21 * a35 * a42 * a53 - a22 * a31 * a45 * a53 + a21 * a32 * a45 * a53 + a23 * a32 * a41 * a55 - a22 * a33 * a41 * a55 - a23 * a31 * a42 * a55 + a21 * a33 * a42 * a55 + a22 * a31 * a43 * a55 - a21 * a32 * a43 * a55;
  a[4][2] = a15 * a33 * a42 * a51 - a13 * a35 * a42 * a51 - a15 * a32 * a43 * a51 + a12 * a35 * a43 * a51 + a13 * a32 * a45 * a51 - a12 * a33 * a45 * a51 - a15 * a33 * a41 * a52 + a13 * a35 * a41 * a52 + a15 * a31 * a43 * a52 - a11 * a35 * a43 * a52 - a13 * a31 * a45 * a52 + a11 * a33 * a45 * a52 + a15 * a32 * a41 * a53 - a12 * a35 * a41 * a53 - a15 * a31 * a42 * a53 + a11 * a35 * a42 * a53 + a12 * a31 * a45 * a53 - a11 * a32 * a45 * a53 - a13 * a32 * a41 * a55 + a12 * a33 * a41 * a55 + a13 * a31 * a42 * a55 - a11 * a33 * a42 * a55 - a12 * a31 * a43 * a55 + a11 * a32 * a43 * a55;
  a[4][3] = -a15 * a23 * a42 * a51 + a13 * a25 * a42 * a51 + a15 * a22 * a43 * a51 - a12 * a25 * a43 * a51 - a13 * a22 * a45 * a51 + a12 * a23 * a45 * a51 + a15 * a23 * a41 * a52 - a13 * a25 * a41 * a52 - a15 * a21 * a43 * a52 + a11 * a25 * a43 * a52 + a13 * a21 * a45 * a52 - a11 * a23 * a45 * a52 - a15 * a22 * a41 * a53 + a12 * a25 * a41 * a53 + a15 * a21 * a42 * a53 - a11 * a25 * a42 * a53 - a12 * a21 * a45 * a53 + a11 * a22 * a45 * a53 + a13 * a22 * a41 * a55 - a12 * a23 * a41 * a55 - a13 * a21 * a42 * a55 + a11 * a23 * a42 * a55 + a12 * a21 * a43 * a55 - a11 * a22 * a43 * a55;
  a[4][4] = a15 * a23 * a32 * a51 - a13 * a25 * a32 * a51 - a15 * a22 * a33 * a51 + a12 * a25 * a33 * a51 + a13 * a22 * a35 * a51 - a12 * a23 * a35 * a51 - a15 * a23 * a31 * a52 + a13 * a25 * a31 * a52 + a15 * a21 * a33 * a52 - a11 * a25 * a33 * a52 - a13 * a21 * a35 * a52 + a11 * a23 * a35 * a52 + a15 * a22 * a31 * a53 - a12 * a25 * a31 * a53 - a15 * a21 * a32 * a53 + a11 * a25 * a32 * a53 + a12 * a21 * a35 * a53 - a11 * a22 * a35 * a53 - a13 * a22 * a31 * a55 + a12 * a23 * a31 * a55 + a13 * a21 * a32 * a55 - a11 * a23 * a32 * a55 - a12 * a21 * a33 * a55 + a11 * a22 * a33 * a55;
  a[4][5] = -a15 * a23 * a32 * a41 + a13 * a25 * a32 * a41 + a15 * a22 * a33 * a41 - a12 * a25 * a33 * a41 - a13 * a22 * a35 * a41 + a12 * a23 * a35 * a41 + a15 * a23 * a31 * a42 - a13 * a25 * a31 * a42 - a15 * a21 * a33 * a42 + a11 * a25 * a33 * a42 + a13 * a21 * a35 * a42 - a11 * a23 * a35 * a42 - a15 * a22 * a31 * a43 + a12 * a25 * a31 * a43 + a15 * a21 * a32 * a43 - a11 * a25 * a32 * a43 - a12 * a21 * a35 * a43 + a11 * a22 * a35 * a43 + a13 * a22 * a31 * a45 -a12 * a23 * a31 * a45 - a13 * a21 * a32 * a45 + a11 * a23 * a32 * a45 + a12 * a21 * a33 * a45 - a11 * a22 * a33 * a45;
  a[5][1] = a24 * a33 * a42 * a51 - a23 * a34 * a42 * a51 - a24 * a32 * a43 * a51 + a22 * a34 * a43 * a51 + a23 * a32 * a44 * a51 - a22 * a33 * a44 * a51 - a24 * a33 * a41 * a52 + a23 * a34 * a41 * a52 + a24 * a31 * a43 * a52 - a21 * a34 * a43 * a52 - a23 * a31 * a44 * a52 + a21 * a33 * a44 * a52 + a24 * a32 * a41 * a53 - a22 * a34 * a41 * a53 - a24 * a31 * a42 * a53 + a21 * a34 * a42 * a53 + a22 * a31 * a44 * a53 - a21 * a32 * a44 * a53 - a23 * a32 * a41 * a54 + a22 * a33 * a41 * a54 + a23 * a31 * a42 * a54 - a21 * a33 * a42 * a54 - a22 * a31 * a43 * a54 + a21 * a32 * a43 * a54;
  a[5][2] = -a14 * a33 * a42 * a51 + a13 * a34 * a42 * a51 + a14 * a32 * a43 * a51 - a12 * a34 * a43 * a51 - a13 * a32 * a44 * a51 + a12 * a33 * a44 * a51 + a14 * a33 * a41 * a52 - a13 * a34 * a41 * a52 - a14 * a31 * a43 * a52 + a11 * a34 * a43 * a52 + a13 * a31 * a44 * a52 - a11 * a33 * a44 * a52 - a14 * a32 * a41 * a53 + a12 * a34 * a41 * a53 + a14 * a31 * a42 * a53 - a11 * a34 * a42 * a53 - a12 * a31 * a44 * a53 + a11 * a32 * a44 * a53 + a13 * a32 * a41 * a54 - a12 * a33 * a41 * a54 - a13 * a31 * a42 * a54 + a11 * a33 * a42 * a54 + a12 * a31 * a43 * a54 - a11 * a32 * a43 * a54;
  a[5][3] = a14 * a23 * a42 * a51 - a13 * a24 * a42 * a51 - a14 * a22 * a43 * a51 + a12 * a24 * a43 * a51 + a13 * a22 * a44 * a51 - a12 * a23 * a44 * a51 - a14 * a23 * a41 * a52 + a13 * a24 * a41 * a52 + a14 * a21 * a43 * a52 - a11 * a24 * a43 * a52 - a13 * a21 * a44 * a52 + a11 * a23 * a44 * a52 + a14 * a22 * a41 * a53 - a12 * a24 * a41 * a53 - a14 * a21 * a42 * a53 + a11 * a24 * a42 * a53 + a12 * a21 * a44 * a53 - a11 * a22 * a44 * a53 - a13 * a22 * a41 * a54 + a12 * a23 * a41 * a54 + a13 * a21 * a42 * a54 - a11 * a23 * a42 * a54 - a12 * a21 * a43 * a54 + a11 * a22 * a43 * a54;
  a[5][4] = -a14 * a23 * a32 * a51 + a13 * a24 * a32 * a51 + a14 * a22 * a33 * a51 - a12 * a24 * a33 * a51 - a13 * a22 * a34 * a51 + a12 * a23 * a34 * a51 + a14 * a23 * a31 * a52 - a13 * a24 * a31 * a52 - a14 * a21 * a33 * a52 + a11 * a24 * a33 * a52 + a13 * a21 * a34 * a52 - a11 * a23 * a34 * a52 - a14 * a22 * a31 * a53 + a12 * a24 * a31 * a53 + a14 * a21 * a32 * a53 - a11 * a24 * a32 * a53 - a12 * a21 * a34 * a53 + a11 * a22 * a34 * a53 + a13 * a22 * a31 * a54 - a12 * a23 * a31 * a54 - a13 * a21 * a32 * a54 + a11 * a23 * a32 * a54 + a12 * a21 * a33 * a54 - a11 * a22 * a33 * a54;
  a[5][5] = a14 * a23 * a32 * a41 - a13 * a24 * a32 * a41 - a14 * a22 * a33 * a41 + a12 * a24 * a33 * a41 + a13 * a22 * a34 * a41 - a12 * a23 * a34 * a41 - a14 * a23 * a31 * a42 + a13 * a24 * a31 * a42 + a14 * a21 * a33 * a42 - a11 * a24 * a33 * a42 - a13 * a21 * a34 * a42 + a11 * a23 * a34 * a42 + a14 * a22 * a31 * a43 - a12 * a24 * a31 * a43 - a14 * a21 * a32 * a43 + a11 * a24 * a32 * a43 + a12 * a21 * a34 * a43 - a11 * a22 * a34 * a43 - a13 * a22 * a31 * a44 + a12 * a23 * a31 * a44 + a13 * a21 * a32 * a44 - a11 * a23 * a32 * a44 - a12 * a21 * a33 * a44 + a11 * a22 * a33 * a44;

  det = 1.0 / det;
  scal( n * n, det, &a[1][1], 1 );
...
// inverse is returned in matrix a
{
  ...
  if ( n == 5 ) return( inverse5x5( n, a ) );

  size_t* idx = getivector( n, ( size_t )( 0 ) );
...
// option to remove
static int evdcmp1x1( const size_t n, double** vecs, double* vals )
// eigenvalue decomposition on 1 x 1 matrix
{
  if ( n != 1 ) return 1;
...
// option to remove
static int evdcmp2x2( const size_t n, double** vecs, double* vals )
// eigenvalue decomposition on 2 x 2 matrix
{
  if ( n != 2 ) return 1;

  const double a = vecs[1][1];
  const double b = vecs[1][2];
  const double c = vecs[2][1];
  const double d = vecs[2][2];

  // eigenvalues
  const double val1 = 0.5 * ( ( a + d ) + sqrt( pow( a - d, 2.0 ) + 4.0 * b * c ) );
  const double val2 = 0.5 * ( ( a + d ) - sqrt( pow( a - d, 2.0 ) + 4.0 * b * c ) );
  vals[1] = val1;
  vals[2] = val2;

  // administration
  const double wmax = fmax( val1, val2 );
  const double u = fmax( wmax, wmax * wmax );
  const double limit = 256.0 * DBL_EPSILON * u * u;
...
// option to remove
static int evdcmp3x3( const size_t n, double** vecs, double* vals )
// Calculates the eigenvalues and normalized eigenvectors of a symmetric 3x3 matrix a
// using Cardano's method for the eigenvalues
// and an analytical method based on vector cross products for the eigenvectors
// Reference: Kopp (2008). Efficient numerical diagonalization of hermitian 3x3 matrices.
{
  if ( n != 3 ) return 1;
  ...
  // switch to zero-based hard coded 3 times 3
  double A[3][3] = { 0 };
  for ( size_t i = 1; i <= 3; i++ ) {
    for ( size_t j = 1; j <= 3; j++ ) A[i - 1][j - 1] = vecs[i][j];
  }
  double Q[3][3] = { 0 };
  double w[3] = { 0 };
  ...
  // eigenvalues
  const double de = A[0][1] * A[1][2];
  const double dd = SQR( A[0][1] );
  const double ee = SQR( A[1][2] );
  const double ff = SQR( A[0][2] );
  const double m = A[0][0] + A[1][1] + A[2][2];
  const double c1 = ( A[0][0] * A[1][1] + A[0][0] * A[2][2] + A[1][1] * A[2][2] ) - ( dd + ee + ff );
  const double c0 = A[2][2] * dd + A[0][0] * ee + A[1][1] * ff - A[0][0] * A[1][1] * A[2][2] - 2.0 * A[0][2] * de;
  const double p = SQR( m ) - 3.0 * c1;
  const double q = m * ( p - c1 * 3.0 / 2.0 ) - c0 * 27.0 / 2.0;
  const double sqrt_p = sqrt( fabs( p ) );
  double phi = 27.0 * ( 0.25 * SQR( c1 ) * ( p - c1 ) + c0 * ( q + c0 * 27.0 / 4.0 ) );
  phi = ( 1.0 / 3.0 ) * atan2( sqrt( fabs( phi ) ), q );
  const double c = sqrt_p * cos( phi );
  const double s = ( 1.0 / M_SQRT3 ) * sqrt_p * sin( phi );
  w[1] = ( 1.0 / 3.0 ) * ( m - c );
  w[2] = w[1] + s;
  w[0] = w[1] + c;
  w[1] -= s;
  ...
  // eigenvectors
  const double wmax = fmax( fmax( fabs( w[0] ), fabs( w[1] ) ), fabs( w[2] ) );
  const double u = fmax( wmax, wmax * wmax );
  const double limit = 256.0 * DBL_EPSILON * u * u;
  const double thresh = SQR( 8.0 * DBL_EPSILON * wmax );
  const double n0tmp = SQR( A[0][1] ) + SQR( A[0][2] );
  const double n1tmp = SQR( A[0][1] ) + SQR( A[1][2] );
  ...
  double norm = SQR( Q[0][0] ) + SQR( Q[1][0] ) + SQR( Q[2][0] );
  if ( norm <= limit ) return retval = 1;
  double n0 = n0tmp + SQR( A[0][0] );
  double n1 = n1tmp + SQR( A[1][1] );
  double error = n0 * n1;
  if ( n0 <= thresh ) {
    Q[0][0] = 1.0;
    Q[1][0] = 0.0;
    ...
    norm = sqrt( 1.0 / norm );
    for ( size_t j = 0; j < 3; j++ ) Q[j][0] = Q[j][0] * norm;
  }
  ...
  if ( fabs( t ) > 8.0 * DBL_EPSILON * wmax ) {
    ...
    if ( n0 <= thresh ) {
      ...
      norm = sqrt( 1.0 / norm );
      for ( size_t j = 0; j < 3; j++ ) Q[j][1] = Q[j][1] * norm;
    }
  }
  else {
    A[1][0] = A[0][1];
    ...
    if ( i == 3 ) {
      for ( size_t j = 0; j < 3; j++ ) if ( Q[j][0] != 0.0 ) {
  ...
  // switch back to one-based and return properly
  for ( i = 1; i <= 3; i++ ) {
    vals[i] = w[i - 1];
    for ( size_t j = 1; j <= 3; j++ ) vecs[i][j] = Q[i - 1][j - 1];
  }
  ...
  for ( i = 1; i <= n - 1; i++ ) {
    ...
    for ( size_t j = i + 1; j <= n; j++ ) {
      if ( vals[j] > work ) work = vals[k = j];
    }
    if ( k != i ) {
      vals[k] = vals[i];
      vals[i] = work;
      for ( size_t j = 1; j <= n; j++ ) {
        const double d = vecs[j][i];
        vecs[j][i] = vecs[j][k];
        vecs[j][k] = d;
      }
    }
...
// the eigenvalues are returned in vector vals
{
  ...
  if ( n == 1 ) return( evdcmp1x1( n, vecs, vals ) );
  if ( n == 2 ) if ( 0 == evdcmp2x2( n, vecs, vals ) ) return retval;
  if ( n == 3 ) if ( 0 == evdcmp3x3( n, vecs, vals ) ) return retval;
...
// option to remove
static int solve5x5( const size_t n, double** a, double* b )
{
  int retval = inverse5x5( n, a );
  if ( 0 != retval ) return retval;
  double* c = getvector( n, 0.0 );
  copyall( n, &b[1], &c[1] );
  gemv( false, n, n, 1.0, a, c, 0.0, b );
...
// revised feb 1995 to accompany reprinting of the book by SIAM
{
  ...
  size_t * index = getivector( n, ( size_t )( 0 ) );
...
static size_t unique( const size_t n, double* x, double* w )
{
  ...
  // sort data
  size_t* index = getivector( count, ( size_t )( 0 ) );
  dsort( count, x, index );
  freeivector( index );
...
static bool checkandorderknotsequence( const size_t ninner, double* iknots, double* boundaries )
{
  ...
  size_t* index = getivector( ninner, ( size_t )( 0 ) );
...
static double** bsplinebasis( const size_t n, double* x, double* w, const size_t degree, const size_t ninner, double* iknots, double* boundaries )
{
  ...
  size_t* l = getivector( n, ( size_t )( 0 ) );
...
void R_distance( double *x, int *nr, int *nc, double *d, int *diag,	double *p )
{
  int i, j = 0;
  size_t ij;
  ...
  if (R_num_math_threads > 0)	nthreads = R_num_math_threads;
  else nthreads = 1;
  if (nthreads == 1) {
	  ij = 0;
	  for( j = 0; j <= *nr; j++ ) for( i = j+dc; i < *nr; i++ ) d[ij++] = distfun( x, *nr, *nc, i, j );
  }
  else
  ...
  for( j = 0; j <= *nr; j++ ) {
    ...
    for( i = j + dc; i < *nr; i++ ) d[ij++] = distfun( x, *nr, *nc, i, j );
  }
}

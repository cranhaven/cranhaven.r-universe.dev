...
#' (\url{https://CRAN.R-project.org/package=TTR}) and are included as a matter of convenience.
#' 
...
#' 
#' @references The Gaussian Smoothing component of the \code{smoother} package has been loosley adapted from elsewhere
#' 
#' @name smoother
#' @rdname smoother
#' @aliases smoother

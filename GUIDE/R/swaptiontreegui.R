...
#         dev.new()
    ...
    rp.textentry(panel=my.panel,variable=strike,action=my.redraw,labels="strike               ",initval=0)
    ...
    rp.textentry(panel=my.panel,variable=fixedrate,action=my.redraw,labels="Fixed Rate      ",initval=4.5)

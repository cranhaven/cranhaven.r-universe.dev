...
function(){
  ...
  rp.textentry(panel=my.panel,variable=income,labels="Dividend(s):            ",action=my.redraw,initval=0)
  rp.textentry(panel=my.panel,variable=incometime,labels="Dividend times(s): ",action=my.redraw,initval=0)

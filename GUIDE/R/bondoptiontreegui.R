...
#         dev.new()
    ...
    rp.textentry(panel=my.panel,variable=strike,action=my.redraw,labels="Strike price    ",initval=80)
    #rp.textentry(panel=my.panel,variable=Time,action=my.redraw,labels="Time               ",initval=0.25)
    #rp.textentry(panel=my.panel,variable=sigma,action=my.redraw,labels="Volatility         ",initval=0.25)
    ...
    #rp.textentry(panel=my.panel,variable=Div,action=my.redraw,labels="Dividend rate ",initval=0)

Lamb_wsimul <-
function(times, subj, X, y, d, tau,  kn, degree, lambda, hat_Vt, Wtau){
...
for (i in 1:nlam){
ncqrsic = ncqr_wsimul(times, subj, y, X, tau=tau, kn=kn, degree=degree, lambda=lambda[i], lambcross=lambda[i], hat_Vt, Wtau, d)

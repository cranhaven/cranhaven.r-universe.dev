...
X = matrix(X, nrow=dim)
px = ncol(X)
lambdasic = Lamb_CU(times, subj, X, y, d, tau,  kn, degree, lambda, alpha0)$lambdasic

qvc2=qrvcp_CU(times, subj, y, X, tau=tau, kn=kn, degree=degree, lambda=rep(0,px), d, alpha0)$hat_bt #only B-Splines

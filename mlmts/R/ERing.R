...
#' \describe{
#' \item{\code{data}}{A list with 300 MTS.}
...
#' correspond to the training set, whereas the last 270 elements correspond to the test set. The numeric vector \code{classes} is formed

...
#' @usage data(EigenWorms_1)
#' @format A \code{list} with two elements, which are:
#' \describe{
#' \item{\code{data}}{A list with 130 MTS.}
...
#' of the whole dataset are stored here. All these elements but the last two pertain to the training set. The numeric vector \code{classes} is formed

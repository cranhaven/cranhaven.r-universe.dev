#'
#' @title SelfRegulationSCP1
#' @description Multivariate time series (MTS) taken from a healthy subject asked to move a cursor up and down on a computer screen while
#' his cortical potentials were taken.
#' @usage data(SelfRegulationSCP1)
#' @format A \code{list} with two elements, which are:
#' \describe{
#' \item{\code{data}}{A list with 561 MTS.}
#' \item{\code{classes}}{A numeric vector indicating the corresponding classes associated with the elements in \code{data}.}
#' }
#' @details Each element in \code{data} is a matrix formed by 896 rows (time points) indicating time recordings over an interval of 3.5 seconds

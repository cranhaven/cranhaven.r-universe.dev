#'
#' @title LSST
#' @description Multivariate time series (MTS) of simulated light curves imitating astronomical time series from the Large Synoptic Survey
...
#' }
#' @details Each element in \code{data} is a matrix formed by 36 rows (time points) indicating time recordings and 6 columns

...
#ifndef STATTOOLS_TEXPONENTIALTEST_H
#define STATTOOLS_TEXPONENTIALTEST_H
...
struct TExponentialTest {
	...
	using BoxOnObs    = prior::TExponentialInferred<TObservationBase, Type, 1, SpecLambda>;
	...
	TExponentialTest(std::string_view Filename) : lambda("lambda", &boxOnLambda, {Filename, "1"}), boxOnObs(&lambda) {}
};

} // namespace stattools

#endif // STATTOOLS_TEXPONENTIALTEST_H

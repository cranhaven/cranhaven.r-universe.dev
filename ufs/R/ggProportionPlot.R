...
#'
#' This function uses [ufs::confIntProp()] to compute confidence intervals
...
#' @param returnPlotOnly Whether to only return the [ggplot2::ggplot()] plot
#' or the full object including intermediate values and objects.
#' @param x The object to print/plot.
#' @param \dots Any additional arguments are passed on to [base::print()] and
#' [grid::grid.draw()].
#'
#' @return A [ggplot2::ggplot()] object (if `returnPlotOnly` is TRUE),
#' or an object containing that [ggplot2::ggplot()] object and intermediate
#' products.
#' @author Gjalt-Jorn Peters
#'
#' Maintainer: Gjalt-Jorn Peters <ufs@@opens.science>
#' @seealso [ufs::confIntProp()] and [stats::binom.test()]

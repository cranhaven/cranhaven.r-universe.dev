...
#' the resulting functions are used, e.g. [stats::dnorm()] and
#' [stats::qnorm()] for the normal curve).
#' @param \dots Any additional arguments are passed to the quantile function
#' (e.g. [stats::qnorm()]). Because of these dots, any following arguments
...
#' specified here.
#' @param observedOnX Whether to plot the observed values (if `TRUE`) or
#' the theoretically expected values (if `FALSE`) on the X axis. The other

...
#'
#' This function uses [pwr::pwr.anova.test()] from the [pwr::pwr-package]
#' package in combination with [ufs::convert.cohensf.to.omegasq()] and
#' [ufs::convert.omegasq.to.cohensf()] to provide power analyses for Omega
#' Squared.
#'
#' This function was written to work similarly to the power functions in the
#' [pwr::pwr-package] package.
#'
...
#' @seealso [pwr::pwr.anova.test()],
#' [ufs::convert.cohensf.to.omegasq()],
#' [ufs::convert.omegasq.to.cohensf()]
#'
#' @rdname pwr.omegasq
#' @keywords htest
#' @examples

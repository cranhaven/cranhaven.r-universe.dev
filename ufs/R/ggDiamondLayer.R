...
#' These colors must be valid arguments to [grDevices::colorRamp()] (and
#' therefore, to [grDevices::col2rgb()]).
...
#' will be passed on to [ggplot2::geom_polygon()].
...
#' [ggplot2::geom_polygon()]. This can be used to set, for example, the
#' `alpha` value of the diamonds. Additional arguments for
#' `rawDataDiamondLayer` are passed on to [ggplot2::geom_jitter()].
...
#' @return `ggDiamondLayer` returns a [ggplot2::ggplot()]
#' [ggplot2::geom_polygon()] object, which can then be used in
#' [ggplot2::ggplot()] plots (as [diamondPlot()] does).
#'
...
#'
#' `rawDataDiamondLayer` returns a [ggplot2::geom_jitter()] object.

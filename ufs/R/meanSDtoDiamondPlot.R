...
#' @param \dots Additional arguments are passed to [ufs::diamondPlot()]
#' and eventually to [ufs::ggDiamondLayer()]. This can be used to, for
#' example, specify two or more colors to use to generate a gradient (using
#' `generateColors` and maybe `fullColorRange`).
#' @return A [ggplot2::ggplot()] plot with a [ufs::ggDiamondLayer()] is
#' returned.
#' @author Gjalt-Jorn Peters
#'
#' Maintainer: Gjalt-Jorn Peters <ufs@@opens.science>
#' @seealso [ufs::meansDiamondPlot()], [ufs::diamondPlot()],
#' [ufs::factorLoadingDiamondCIplot()], [ufs::ggDiamondLayer()]
#' @keywords hplot
#' @examples
#'

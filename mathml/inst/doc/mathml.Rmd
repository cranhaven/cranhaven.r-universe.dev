...
If the first argument of `hook()` is a custom function, and the second argument 
is omitted, `hook` adds a hook with the function body. Note that the function
body should be formatted with "pretty" functions:

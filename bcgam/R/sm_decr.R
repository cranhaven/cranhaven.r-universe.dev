#' @title Specify a smooth and decreasing shape-restriction in a \pkg{bcgam} formula
#'
...
#' @export
#'
#' @details \code{sm.decr} returns the vector \code{x} and assigns five attributes to it: name, shape (2 for  
...
sm.decr <- function (x, numknots = 0, knots = 0, space = "Q") 
{
    cl <- match.call()
    pars <- match.call()[-1]

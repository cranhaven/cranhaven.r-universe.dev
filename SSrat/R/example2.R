...
#' (columns).\cr The result of \code{readratdatafixed("<example2.rat.txt>")}. A
...
#' @name example2.rat
#' @docType data
#' @format This dataframe has 10 rated persons, but only 7 raters.  \describe{
#' \item{schoolid}{a numeric vector, identifying the second group
#' level}
#' \item{groupid}{a numeric vector, identifying the first group
#' level.}

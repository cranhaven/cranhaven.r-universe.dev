...
#' 
#' The result of \code{readratdatafixed("<example4.rat.txt>")}. A 7-point
...
#' @name example4.rat
#' @docType data
#' @format A data frame with 10 observations of 9 ratings; some of the ratings
#' are missing.  \describe{ \item{schoolid}{a numeric vector,

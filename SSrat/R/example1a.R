...
#' 
#' Ratings with the names of the raters (and of the assessed).\cr The result of
#' \code{readratdatafixed("<example1a.rat.txt>")}. A 7-point rating scale has
...
#' \item{resplabel}{a string vector with an additional identifier of
#' the raters (and assessed).} \item{schoolid}{a numeric vector,
#' identifying the second group level.} \item{groupid}{a numeric
#' vector, identifying the first group level.} \item{respid}{a numeric
#' vector, identifying the individual.} \item{r01}{ratings received by

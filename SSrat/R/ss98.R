...
#' school, year 1998
#' 
#' Rating data of 1998. Measurements of these Dutch primary school children
...
#' ratings (r01..r30).  \code{schoolid} a numeric vector, identifying the
...
#' \code{r01:r30} ratings received by respondent 1..30.
#' 
#' @name Ss98.rat
#' @docType data
#' @seealso \code{\link{Ss96.rat}} \code{\link{Ss97.rat}} \code{\link{bg}}
#' @source %% ~~ reference to a publication or URL from which the data were
#' obtained ~~ Maassen, G.H., Van Boxtel, H.W., & Goossens, F.A. (2005).

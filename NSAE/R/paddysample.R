...
#'
#' @description  Dataset on paddy yield for sample area used by Chandra et al. (2016).
#'
#' @docType data
#'
#' @usage data(paddysample)
#'
#' @format A data frame with 58 observations on the following 8 variables:
#' \describe{

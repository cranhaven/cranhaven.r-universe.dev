        ...
        do t = 1,TT
          ...
          if(p==0) then
            ...
            if(p==1) then
              ...
              do u = 1,k
                tmp1 = ((Y(i,t,indo1)-Mu(indo1,u))**two)/Si(indo1,indo1)
                f = f0*exp(-tmp1/two)
                Phi(i,u,t) = max(f,eps)
              end do
            else
              ...
              do u = 1,k
                tmp = matmul(transpose(iU),(Y(i,t,indo)-Mu(indo,u)))

...
#' @description Compute the extremophile distribution of leaf zenith angle.
#' @return The extremophile distribution of leaf zenith angle.
...
extremophileDis<-function()
{
  ...
  {
    #extremophile- oblique leaves most frequent

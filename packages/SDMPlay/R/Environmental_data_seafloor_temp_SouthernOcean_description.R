...
#'
#' @description Average seafloor temperature layer at the scale of the Southern Ocean at 0.1° resolution
#'
#' @usage
#'data("seafloor_temp_2005_2012_mean_SO")
#'
#' @format
#' Three RasterLayers. Grid: nrow= 350, ncol= 3600, ncells= 1260000 pixels. Spatial resolution: 0.1. Spatial extent: -180, 180, -80, -45 (longmin, longmax, latmin, latmax); \cr Crs : +proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0. Origin=0
#'
#'@source

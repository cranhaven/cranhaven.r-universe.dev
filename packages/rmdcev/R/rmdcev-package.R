...
#' welfare calculation (Lloyd-Smith (2018) <\doi{10.1016/j.jocm.2017.12.002}>) for policy simulation. More information on the package is
#' provided in Lloyd-Smith (2020) <\doi{10.32614/RJ-2021-015}>).
#'
#' @docType package
#' @name rmdcev
#' @aliases rmdcev
...
#'
#' @references
#' Lloyd-Smith, P. (2020). Kuhn-Tucker and Multiple Discrete-Continuous Extreme Value (MDCEV) Model Estimation and Simulation in R: The rmdcev Package. R Journal. 12(2): 251-265. \doi{10.32614/RJ-2021-015}{(link)}
#'
#' Bhat, CR (2008). The multiple discrete-continuous extreme value (MDCEV) model: Role of utility function parameters, identification considerations, and model extensions. Transportation Research Part B: Methodological, 42(3): 274-303.\doi{10.1016/j.trb.2007.06.002}{(link)}

#' Lloyd-Smith, P (2018). A new approach to calculating welfare measures in Kuhn-Tucker demand models. Journal of Choice Modeling 26:19–27. \doi{10.1016/j.jocm.2017.12.002}{(link)}

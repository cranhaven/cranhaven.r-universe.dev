...
#include "stanExports_survival_mspline.h"

RCPP_MODULE(stan_fit4survival_mspline_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_survival_mspline")

...
static constexpr std::array<const char*, 53> locations_array__ =
  ...
  " (in 'string', line 43, column 6 to column 40)",
  " (in 'string', line 41, column 19 to line 44, column 5)",
  " (in 'string', line 41, column 4 to line 44, column 5)",
  " (in 'string', line 45, column 4 to column 38)",
  " (in 'string', line 38, column 19 to line 46, column 3)",
  " (in 'string', line 38, column 2 to line 46, column 3)",
  " (in 'string', line 48, column 2 to column 69)",
  " (in 'string', line 49, column 2 to column 48)",
  " (in 'string', line 50, column 2 to column 51)",
  " (in 'string', line 51, column 2 to line 52, column 41)",
  ...
  " (in 'string', line 29, column 8 to column 11)",
  " (in 'string', line 29, column 20 to column 23)",
  " (in 'string', line 33, column 9 to column 12)",
  " (in 'string', line 58, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_lasso_MA final : public model_base_crtp<model_lasso_MA> {
private:
  int N;
...
public:
  ~model_lasso_MA() {}
  model_lasso_MA(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_lasso_MA_namespace::model_lasso_MA";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = K + 1 + 1 + M_1 + (M_1 * N_1);
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_lasso_MA_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_lasso_MA_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"b", "Int_c", "lasso_inv_lambda",
                "sd_1", "z_1"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"sigma", "r_1_1"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"Int_c\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lasso_inv_lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sd_1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(M_1) + "},\"block\":\"parameters\"},{\"name\":\"z_1\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M_1) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_1) + "}},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"r_1_1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_1) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"betas\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"generated_quantities\"},{\"name\":\"tau2\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((K + 1) + 1) + M_1) + (M_1 * N_1));
    const size_t num_transformed = emit_transformed_parameters * ((1 + N_1));
...
using stan_model = model_lasso_MA_namespace::model_lasso_MA;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_lasso_MA_namespace::profiles__;
}
#endif
#endif

...
static constexpr std::array<const char*, 73> locations_array__ =
  ...
  " (in 'string', line 53, column 20 to column 23)",
...
public:
  ...
  model_lasso_MA_ml_noint(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_lasso_MA_ml_noint_namespace::model_lasso_MA_ml_noint";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    num_params_r__ = K + 1 + M_1 + (M_1 * N_1) + M_2 + (M_2 * N_2);
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_lasso_MA_ml_noint_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_lasso_MA_ml_noint_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"b", "lasso_inv_lambda", "sd_1",
                "z_1", "sd_2", "z_2"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"lasso_inv_lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sd_1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(M_1) + "},\"block\":\"parameters\"},{\"name\":\"z_1\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M_1) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_1) + "}},\"block\":\"parameters\"},{\"name\":\"sd_2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(M_2) + "},\"block\":\"parameters\"},{\"name\":\"z_2\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M_2) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_2) + "}},\"block\":\"parameters\"},{\"name\":\"r_1_1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_1) + "},\"block\":\"transformed_parameters\"},{\"name\":\"r_2_1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"betas\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"generated_quantities\"},{\"name\":\"tau2_w\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"tau2_b\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((K + 1) + M_1) + (M_1 * N_1)) + M_2) +
      (M_2 * N_2));
    const size_t num_transformed = emit_transformed_parameters * ((N_1 +
      N_2));
    const size_t num_gen_quantities = emit_generated_quantities * (((K + 1) +
      1));

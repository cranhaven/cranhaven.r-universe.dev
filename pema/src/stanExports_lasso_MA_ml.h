...
static constexpr std::array<const char*, 76> locations_array__ =
  ...
  " (in 'string', line 52, column 20 to column 23)",
  " (in 'string', line 53, column 18 to column 21)",
  " (in 'string', line 54, column 8 to column 11)",
  " (in 'string', line 54, column 20 to column 23)",
...
public:
  ~model_lasso_MA_ml() {}
  model_lasso_MA_ml(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_lasso_MA_ml_namespace::model_lasso_MA_ml";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    num_params_r__ = K + 1 + 1 + M_1 + (M_1 * N_1) + M_2 + (M_2 * N_2);
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_lasso_MA_ml_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      sd_2 = in__.template read_constrain_lb<
               Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(0, lp__,
               M_2);
        ...
        "assigning variable r_2_1");
      {
        ...
        lp_accum__.add((stan::math::student_t_lpdf<false>(sd_2, 3, 0, 2.5) -
          (1 * stan::math::student_t_lccdf(0, 3, 0, 2.5))));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_lasso_MA_ml_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      Eigen::Matrix<double,-1,1> sd_2 =
        Eigen::Matrix<double,-1,1>::Constant(M_2,
          std::numeric_limits<double>::quiet_NaN());
      current_statement__ = 6;
      sd_2 = in__.template read_constrain_lb<
               Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(0, lp__,
      ...
      std::vector<Eigen::Matrix<double,-1,1>> z_2 =
        std::vector<Eigen::Matrix<double,-1,1>>(M_2,
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"b", "Int_c", "lasso_inv_lambda",
                "sd_1", "z_1", "sd_2", "z_2"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"r_1_1", "r_2_1"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"Intercept", "betas", "tau2_w", "tau2_b"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  get_dims(std::vector<std::vector<size_t>>& dimss__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::vector<size_t>>
        temp{std::vector<size_t>{static_cast<size_t>(N_1)},
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((((K + 1) + 1) + M_1) + (M_1 * N_1)) +
      M_2) + (M_2 * N_2));
    const size_t num_transformed = emit_transformed_parameters * ((N_1 +
      N_2));

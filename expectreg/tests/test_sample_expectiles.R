...
stopifnot(all(0<penorm(enorm(y)) & penorm(enorm(y))<1))

stopifnot(max(abs(pebeta(ebeta(y))-y))<.000001)
stopifnot(all(0<pebeta(ebeta(y)) & pebeta(ebeta(y))<1))

stopifnot(max(abs(peunif(eunif(y))-y))<.000001)
stopifnot(all(0<peunif(eunif(y)) & peunif(eunif(y))<1))

stopifnot(max(abs(pet(et(y,2),2)-y))<.000001)
stopifnot(all(0<pet(et(y,2),2) & pet(et(y,2),2)<1))

stopifnot(max(abs(pelnorm(elnorm(y))-y))<.000001)
stopifnot(all(0<pelnorm(elnorm(y)) & pelnorm(elnorm(y))<1))

stopifnot(max(abs(pegamma(egamma(y,2),2)-y))<.000001)
stopifnot(all(0<pegamma(egamma(y,2),2) & pegamma(egamma(y,2),2)<1))

stopifnot(max(abs(peexp(eexp(y))-y))<.000001)
stopifnot(all(0<peexp(eexp(y)) & peexp(eexp(y))<1))

stopifnot(max(abs(pechisq(echisq(y,2),2)-y))<.000001)
stopifnot(all(0<pechisq(echisq(y,2),2) & pechisq(echisq(y,2),2)<1))

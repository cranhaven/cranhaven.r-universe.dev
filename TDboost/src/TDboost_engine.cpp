...
TDboostRESULT CTDboost::Initialize
(
    CDataset *pData,
    CDistribution *pDist,
    double dLambda,
...
TDboostRESULT CTDboost::Predict
(
    unsigned long iVar,
...
TDboostRESULT CTDboost::GetVarRelativeInfluence
(
    double *adRelInf,
    unsigned long cTrees
)
...
TDboostRESULT CTDboost::PrintTree()
{
    TDboostRESULT hr = TDboost_OK;
...
TDboostRESULT CTDboost::iterate
(
    double *adF,
    double &dTrainError,
    double &dValidError,
...
TDboostRESULT CTDboost::TransferTreeToRList
(
    int *aiSplitVar,
    double *adSplitPoint,
    int *aiLeftNode,

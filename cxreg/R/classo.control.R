...
#'
#' If called with no arguments, \code{classo.control()} returns a list with the
...
#' @param eps minimum value of lambda.min.ratio (see classo); factory default=
#' 1.0e-6
...
#' factory default = 100
#' @param itrace If 1 then progress bar is displayed when running \code{classo}

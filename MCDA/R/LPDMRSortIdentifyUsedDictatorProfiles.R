#' Identify dictator profiles evaluations that have an impact on the final
...
#' categories, whereas the columns are named according to the criteria.
...
#' named according to the criteria. By default no veto profiles are needed.

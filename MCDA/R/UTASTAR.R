...
#' 
#' Elicits value functions from a ranking of alternatives, according to the
#' UTASTAR method.
#' 
#' 
...
#' input ranking and the one obtained via the elicited value functions.}
#' \item{errors}{A list containing the errors (sigmaPlus and sigmaMinus) which
#' have to be substracted and added to the overall values of the alternatives
#' in order to respect the input ranking.} \item{minimumWeightsPO}{In case a
...
#' @references Siskos, Y. and D. Yannacopoulos, UTASTAR: An ordinal regression

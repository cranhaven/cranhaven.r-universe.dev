...
#include "Hungarian.h"
 ...
 TreeProbability::TreeProbability(std::vector<std::vector<size_t>>& child_nodeIDs, std::vector<size_t>& split_varIDs,
                                  ...
                                  std::vector<std::vector<std::vector<double>>>& split_multvalues, std::vector<std::vector<size_t>>& child_muwnodeIDs, std::vector<size_t>& split_muwvarIDs, std::vector<std::vector<double>>& split_muwvalues, std::vector<double>* class_values, std::vector<uint>* response_classIDs,
 ...
 void TreeProbability::drawPartitionsMuw(size_t nodeID, std::vector<std::vector<double>> &split_muwvalues_temp, std::vector<size_t> &varIDs_temp, std::vector<size_t> varIDs_sel)
 {
 ...
 void TreeProbability::partitionNodeInternal(size_t nodeID, std::vector<std::vector<double>> split_muwvalues_temp, std::vector<size_t> varIDs_temp)
 {
 ...
 void TreeProbability::splitNodeMuwUnivInternal(size_t nodeID, std::vector<size_t> varIDs_sel)
 {
 ...
 void TreeProbability::computeImportanceMuw(std::vector<double> &forest_classfoc, std::vector<double> &forest_discr)
 {
 ...
 double TreeProbability::computeImportanceDifference(size_t nodeID, std::vector<size_t> oob_sampleIDs_thisnodeID, size_t classfoc_ind)
 {
 ...
 double TreeProbability::computeImportanceNode(size_t nodeID, std::vector<size_t> oob_sampleIDs_thisnodeID, size_t classfoc_ind)
 {
 ...
 double TreeProbability::computeImportanceNodeClassfoc(size_t nodeID, std::vector<size_t> oob_sampleIDs_thisnodeID)
 {
 ...
 // for binary splits:
 double TreeProbability::computeImportanceNodeDiscr(size_t nodeID, std::vector<size_t> oob_sampleIDs_thisnodeID)
 {
 ...
 double TreeProbability::computeGiniImpurity(std::vector<size_t> oob_sampleIDs_thisnodeID)
 {
 ...
 double TreeProbability::computeImportanceNodePermuted(size_t nodeID, std::vector<size_t> oob_sampleIDs_thisnodeID, std::vector<size_t> oob_sampleIDs_thisnodeID_permuted, size_t classfoc_ind)
 {
 ...
 double TreeProbability::computeImportanceNodePermutedClassfoc(size_t nodeID, std::vector<size_t> oob_sampleIDs_thisnodeID, std::vector<size_t> oob_sampleIDs_thisnodeID_permuted)
 {
 ...
 double TreeProbability::computeImportanceNodePermutedDiscr(size_t nodeID, std::vector<size_t> oob_sampleIDs_thisnodeID, std::vector<size_t> oob_sampleIDs_thisnodeID_permuted)
 {

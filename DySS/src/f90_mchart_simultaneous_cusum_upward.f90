subroutine f90_mchart_simultaneous_CUSUM_upward(eeijk,nobs,&
           nind,nmaxobs,ndim,allowance,limit,CCij,SSijk_upward)
...
double precision::SSijk_upward(nind,nmaxobs,ndim)

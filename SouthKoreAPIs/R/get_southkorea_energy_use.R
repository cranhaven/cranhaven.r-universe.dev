...
#' Get South Korea's Energy Use (kg of oil equivalent per capita) from World Bank
#'
#' @description
#' Retrieves South Korea's energy use per capita, measured in kilograms of oil equivalent,
...
#'
#' @export
get_southkorea_energy_use <- function() {
  url <- "https://api.worldbank.org/v2/country/KOR/indicator/EG.USE.PCAP.KG.OE?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)

...
#' Get South Korea's Under-5 Mortality Rate from World Bank
#'
#' @description
#' Retrieves South Korea's under-5 mortality rate, measured as the number of deaths
...
#'
#' @export
get_southkorea_child_mortality <- function() {
  url <- "https://api.worldbank.org/v2/country/KOR/indicator/SH.DYN.MORT?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)

test_that("ffdEvidenceFFBS", {
  ...
  result     <- readRDS(system.file("test_data", 'res_FFBS.Rds', package= "BayesDLMfMRI"))
                
  
  res <- ffdEvidenceFFBS(ffdc = fMRI.data, covariates = covariates, m0 = 0,
                         Cova = 100, delta = 0.95, S0 = 1,n0 = 1, Nsimu1 = 100, Cutpos1 = 30,

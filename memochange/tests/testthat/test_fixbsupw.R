...
expect_error(fixbsupw(c(x,NA), d=d))
expect_error(fixbsupw(x, d=d,bandw=0.3))
expect_error(fixbsupw(x, d=d,tau=2))
expect_warning(fixbsupw(x, d=d, tau=0.1))
x=stats::ts(x)
expect_error(fixbsupw(x, d=d))

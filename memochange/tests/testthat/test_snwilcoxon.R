...
expect_error(snwilcoxon(c(x,NA), d=d))
expect_error(snwilcoxon(x, d=d,tau=2))
expect_warning(snwilcoxon(x, d=d, tau=0.1))
x=stats::ts(x)
expect_error(snwilcoxon(x, d=d))

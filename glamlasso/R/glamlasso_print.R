...
#' @param ... ignored
#' 
#' @details  For the call that produced the object x a two-column data.frame 
#' with columns \code{Df} and \code{lambda} is created. The \code{Df} column is 
#' the number of nonzero coefficients and \code{lambda} is the sequence of 
#' penalty parameters.
#' @return Prints the data.frame described under Details.  
#' 
#' @examples  

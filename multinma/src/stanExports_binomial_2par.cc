...
#include "stanExports_binomial_2par.h"

RCPP_MODULE(stan_fit4binomial_2par_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_binomial_2par")

...
#include "stanExports_survival_param.h"

RCPP_MODULE(stan_fit4survival_param_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_survival_param")

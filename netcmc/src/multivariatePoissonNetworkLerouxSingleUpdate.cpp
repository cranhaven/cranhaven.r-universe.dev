  ...
  
{
  ...
  if(spatialRandomEffectsFixed){
    ...
    List output = multivariatePoissonNetworkLerouxSpatialRandomEffectsUpdate(standardizedX,
                                                                               numberOfResponses,
                                                                               spatialAssignment,
  ...
  if(spatialTauSquaredFixed){
    ...
    spatialTauSquared = multivariatePoissonNetworkLerouxTauSquaredUpdate(squareSpatialNeighbourhoodMatrix,
                                                                              spatialRandomEffects,
                                                                              numberOfResponses,
                                                                              spatialTauSquared,
                                                                              spatialRho,
  ...
  if(spatialRhoFixed){
    ...
    List output = multivariatePoissonNetworkLerouxRhoUpdate(squareSpatialNeighbourhoodMatrix,
                                                              spatialRandomEffects,
                                                              numberOfResponses,
                                                              spatialTauSquared,
                                                              spatialRho,

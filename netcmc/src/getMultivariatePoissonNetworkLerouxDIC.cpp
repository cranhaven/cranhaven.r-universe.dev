                                             ...
                                             int numberOfResponses)
{
  ...
  NumericVector meanLogTheta(numberOfLogLikelihoods);
  ...
  for(int i = 0; i < numberOfResponses; i++) {
    meanLogTheta[Range(i * standardizedX.rows(), ((i + 1) * standardizedX.rows()) - 1)] = matrixVectorMultiplicationRcpp(standardizedX, getSubvector(meanOfBetaSamples, i * numberOfColumnsInX, ((i + 1) * numberOfColumnsInX) - 1))

  ...
  
{
  ...
  if(uRandomEffectsFixed){
    ...
    List output = univariatePoissonNetworkLerouxURandomEffectsUpdate(standardizedX,
                                                                       W,
                                                                       y,
                                                                       numberOfRowsInX,
                                                                       numberOfColumnsInX,
  ...
  if(spatialTauSquaredFixed){
    ...
    double output = univariatePoissonNetworkLerouxTauSquaredUpdate(squareSpatialNeighbourhoodMatrix,
                                                                   spatialRandomEffects,
                                                                   spatialTauSquared,
                                                                   spatialRho,
                                                                   a1,
  ...
  if(sigmaSquaredUFixed){
    ...
    sigmaSquaredU = univariatePoissonNetworkLerouxSigmaSquaredUpdate(uRandomEffects,
                                                                       a2,
                                                                       b2);
  }
  
  List fittedValuesAndLikelihood = getUnivariatePoissonNetworkLerouxFittedValuesAndLikelihoodForDICEveryIteration(standardizedX,
                                                                                                                    y,
                                                                                                                    spatialAssignment,
                                                                                                                    W,
                                                                                                                    beta,

multivariateBinomialNetworkLeroux = function(formula, 
                                              data, 
                                              trials,
  ...
  if(is.null(trials)) {
    trials = rep(1, nrow(data) * numberOfResponses)
  } 
  ...
  output = multivariateBinomialNetworkLerouxAllUpdate(standardizedX = standardizedX,
                                                       trials = trials,
                                                       y = y,

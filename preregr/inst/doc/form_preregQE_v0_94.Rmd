...
This vignette shows the Preregistration Template for Qualitative and Quantitative Ethnographic Studies form (previous versions of this form: [v0.93](https://preregr.opens.science/articles/form_preregQE_v0_93.html)). It can be initialized as follows:

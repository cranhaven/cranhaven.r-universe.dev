...
This vignette shows an inclusive general-purpose registration form (previous versions of this form: [v1.0](https://preregr.opens.science/articles/form_generalPurpose_v1.html)). It can be initialized as follows:

...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_nse");
    reader.add_event(55, 53, "end", "model_nse");
    return reader;
}
#include <stan_meta_header.hpp>
class model_nse
  : public stan::model::model_base_crtp<model_nse> {
private:
        int SIZE;
        vector_d Y;
        vector_d SIGY;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(tau, MU, stan::math::sqrt(B)));
...
typedef model_nse_namespace::model_nse stan_model;
#ifndef USING_R

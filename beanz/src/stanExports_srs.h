...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_srs");
    reader.add_event(79, 77, "end", "model_srs");
    return reader;
}
#include <stan_meta_header.hpp>
class model_srs
  : public stan::model::model_base_crtp<model_srs> {
private:
        int SIZE;
        int NX;
        vector_d Y;
...
typedef model_srs_namespace::model_srs stan_model;
#ifndef USING_R

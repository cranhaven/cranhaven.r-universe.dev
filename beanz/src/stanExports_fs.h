...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_fs");
    reader.add_event(49, 47, "end", "model_fs");
    return reader;
}
#include <stan_meta_header.hpp>
class model_fs
  : public stan::model::model_base_crtp<model_fs> {
private:
        int SIZE;
        vector_d Y;
        vector_d SIGY;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("mu", "SIZE", SIZE);
        context__.validate_dims("parameter initialization", "mu", "vector_d", context__.to_vec(SIZE));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(mu, MU, stan::math::sqrt(B)));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> mu = in__.vector_constrain(SIZE);
        size_t mu_j_1_max__ = SIZE;
        for (size_t j_1__ = 0; j_1__ < mu_j_1_max__; ++j_1__) {
...
typedef model_fs_namespace::model_fs stan_model;
#ifndef USING_R

...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_eds");
    reader.add_event(85, 83, "end", "model_eds");
    return reader;
}
#include <stan_meta_header.hpp>
class model_eds
  : public stan::model::model_base_crtp<model_eds> {
private:
        int SIZE;
        int NX;
        int NTAU;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            pos__ = 0;
            size_t TAUINX_k_0_max__ = NX;
            for (size_t k_0__ = 0; k_0__ < TAUINX_k_0_max__; ++k_0__) {
                TAUINX[k_0__] = vals_i__[pos__++];
            }
            size_t TAUINX_i_0_max__ = NX;
            for (size_t i_0__ = 0; i_0__ < TAUINX_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "TAUINX[i_0__]", TAUINX[i_0__], 0);
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("omega", "NTAU", NTAU);
        context__.validate_dims("parameter initialization", "omega", "double", context__.to_vec(NTAU));
        std::vector<double> omega(NTAU, double(0));
        size_t omega_k_0_max__ = NTAU;
        for (size_t k_0__ = 0; k_0__ < omega_k_0_max__; ++k_0__) {
            omega[k_0__] = vals_r__[pos__++];
        }
        size_t omega_i_0_max__ = NTAU;
        for (size_t i_0__ = 0; i_0__ < omega_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_lb_unconstrain(0, omega[i_0__]);
            } catch (const std::exception& e) {
        ...
        if (!(context__.contains_r("nomega")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable nomega missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("nomega");
        pos__ = 0U;
        validate_non_negative_index("nomega", "NX", NX);
        context__.validate_dims("parameter initialization", "nomega", "vector_d", context__.to_vec(NX));
        Eigen::Matrix<double, Eigen::Dynamic, 1> nomega(NX);
        size_t nomega_j_1_max__ = NX;
        for (size_t j_1__ = 0; j_1__ < nomega_j_1_max__; ++j_1__) {
            nomega(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(nomega);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable nomega: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            size_t omega_d_0_max__ = NTAU;
            omega.reserve(omega_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < omega_d_0_max__; ++d_0__) {
                if (jacobian__)
            ...
            current_statement_begin__ = 37;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> nomega;
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> bgamma(NX);
            ...
            for (int i = 1; i <= NX; ++i) {
                ...
                stan::model::assign(bgamma, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(omega, get_base1(TAUINX, i, "TAUINX", 1), "omega", 1) * get_base1(nomega, i, "nomega", 1)), 
            ...
            for (size_t j_1__ = 0; j_1__ < bgamma_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(bgamma(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: bgamma" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable bgamma: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 44;
            ...
            if (as_bool(logical_eq(0, D))) {
                ...
                for (int i = 1; i <= NTAU; ++i) {
                    ...
                    lp_accum__.add(-(stan::math::log(get_base1(omega, i, "omega", 1))));
                }
            } else {
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> nomega = in__.vector_constrain(NX);
        size_t nomega_j_1_max__ = NX;
        for (size_t j_1__ = 0; j_1__ < nomega_j_1_max__; ++j_1__) {
            vars__.push_back(nomega(j_1__));
        }
        double lp__ = 0.0;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t k_0__ = 0; k_0__ < omega_k_0_max__; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "omega" << '.' << k_0__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t uvs_j_1_max__ = SIZE;
        for (size_t j_1__ = 0; j_1__ < uvs_j_1_max__; ++j_1__) {
        ...
        for (size_t j_1__ = 0; j_1__ < nomega_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "nomega" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
...
typedef model_eds_namespace::model_eds stan_model;
#ifndef USING_R

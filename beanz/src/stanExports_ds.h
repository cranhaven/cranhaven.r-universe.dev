...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ds");
    reader.add_event(75, 73, "end", "model_ds");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ds
  : public stan::model::model_base_crtp<model_ds> {
private:
        int SIZE;
        int NX;
        vector_d Y;
...
typedef model_ds_namespace::model_ds stan_model;
#ifndef USING_R

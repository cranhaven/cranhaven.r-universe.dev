# Start  Inf.D5.calc2() function
###################################################################
# Brianna Hitt

Inf.D5.calc2 <- function(alpha = NULL, probabilities = NULL, 
  ...
  accuracy.mat <- matrix(data = save.it[4:11], nrow = 2, ncol = 4, 
                         byrow = TRUE, 
  ...
  list("algorithm" = "Informative five-stage hierarchical testing",

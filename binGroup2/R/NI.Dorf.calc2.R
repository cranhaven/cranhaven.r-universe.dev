# Start  NI.Dorf.calc2() function
###################################################################
# Brianna Hitt - 12-31-19
# This function is the same as TwoDisease.NI.Dorf(), but no longer 
#   finds the optimal testing configuration. It only calculates 
#   operating characteristics for a specific testing configuration.

NI.Dorf.calc2 <- function(p.vec, Se, Sp, ordering, group.mem, a, 
  ...
  list("algorithm" = "Non-informative two-stage hierarchical testing",
       ...
       "Config" = list("Stage1" = save.it[1]), "p.mat" = joint.p, 
       "ET" = save.it[2], "value" = save.it[3], 

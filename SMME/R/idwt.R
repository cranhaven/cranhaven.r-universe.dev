...
#'
#' @description This function performs a level J decomposition of the input
...
#' depth is used  making \code{iwt(x)} equal to multiplying \code{x} with the
...
out <- IWT(matrix(x, p1, p2 * p3),dim, wf,  J, p1, p2, p3)

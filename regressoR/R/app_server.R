...
app_server <- function( input, output, session ) {
  ...
  callModule(mod_train_test_server, "tt_reg_ui",   updateData, modelos, "reg", codedioma) # Regresión Lineal
  callModule(mod_train_test_server, "tt_regp_ui",  updateData, modelos, "regp", codedioma)  # Regresión Penalizada
  callModule(mod_train_test_server, "tt_tree_ui",  updateData, modelos, "tree", codedioma) # Árboles de regresión
  callModule(mod_train_test_server, "tt_rndf_ui",  updateData, modelos, "rndf", codedioma) # Bosques aleatorios
  callModule(mod_train_test_server, "tt_boost_ui", updateData, modelos, "boost", codedioma) # Potenciación (Boosting) 
  callModule(mod_train_test_server, "tt_knn_ui",   updateData, modelos, "knn", codedioma) # K vecinos más cercanos
  callModule(mod_train_test_server, "tt_svm_ui",   updateData, modelos, "svm", codedioma) # Máquinas de soporte vectorial
  callModule(mod_train_test_server, "tt_rdim_ui",  updateData, modelos, "rdim", codedioma) # Reducción de dimensiones
  callModule(mod_train_test_server, "tt_nnet_ui",  updateData, modelos, "nnet", codedioma) # Redes neuronales

...
## ----fig2,fig.cap='Figura 2. Busqueda en Scopus ',fig.align='center', echo=FALSE, out.width = '90%'----
knitr::include_graphics("../inst/img/Fig2.jpg")

## ----fig3,fig.cap='Figura 3. Pasos para exportar',fig.align='center', echo=FALSE, out.width = '90%'----

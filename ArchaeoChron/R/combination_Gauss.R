...
combination_Gauss <- function(M, s, refYear=NULL, studyPeriodMin, studyPeriodMax, 
  ...
  jags <- jags.model(file =model.file, data = list('Nbobs' = length(M),'M' = M,'s'=s,'ta'=studyPeriodMin,'tb'=studyPeriodMax),

#' @title    ex121 from Duchateau, L. and Janssen, P. and Rowlands, G. J. (1998).\emph{Linear Mixed Models. An Introduction with applications in Veterinary Research}. International Livestock Research Institute.
#' @name     ex121
#' @docType  data
#' @keywords datasets
#' @usage    data(ex121)
#' @format   A \code{data.frame} with 40 rows and 4 variables.
#' @description ex121 is.
#' @details
#'        \itemize{
